...
public class EventsResultsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = database.getReference("All Events");
            ...
            protected void populateViewHolder(EventStatusUpdate eventStatusUpdate, EventStatusModel eventStatus, int i) {
                ...
                eventStatusUpdate.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Toast.makeText(EventsResultsActivity.this,""+clickItem.getName(),Toast.LENGTH_SHORT).show();
                        Intent eventDetail = new Intent(EventsResultsActivity.this,RegisteredDetailActivity.class);
    ...
    private void showUpdateDialog(String key, final EventStatusModel item) {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(EventsResultsActivity.this);
